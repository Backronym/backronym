            ...
            <div className="gridParent">
                <div className="login">
                    <div className="controlsGap">
                        ...
                        <button className="instructionButton how lightButton" onClick={this.props.howToggle}>How To Use</button>
                        <button className="instructionButton what lightButton" onClick={this.props.whatToggle}>What is a Backronym?</button>
                        <footer>
